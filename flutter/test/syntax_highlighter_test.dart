...
void main() {
  group('SyntaxHighlighter', () {
    ...
    test('highlight returns TextSpan for json', () {
      ...
      expect((span as TextSpan).children, isNotNull);
    ...
    test('highlight falls back to plain text for unknown language', () {
      ...
      expect(span, isA<TextSpan>());
      expect((span as TextSpan).text, 'some code');
    ...
    test('json highlighter colorizes strings', () {
      final span = highlighter.highlight('"hello"', 'json') as TextSpan;
    ...
    test('dart highlighter colorizes keywords', () {
      final span = highlighter.highlight('class MyClass {}', 'dart') as TextSpan;
      expect(span.children, isNotNull);
