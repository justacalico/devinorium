...
abstract class AppStateBase extends ChangeNotifier {
  ...
  List<ProjectGroup> get _projectGroups;
  set _projectGroups(List<ProjectGroup> value);
  int? get _selectedProjectGroupId;
  set _selectedProjectGroupId(int? value);
  int? get _groupAssignProjectId;
  set _groupAssignProjectId(int? value);
  int? get _renameProjectGroupId;
  set _renameProjectGroupId(int? value);
  bool get _projectGroupsUnsupported;
  set _projectGroupsUnsupported(bool value);
  bool get _newGroupFromManage;
  set _newGroupFromManage(bool value);
  ...
  set _gitPanelOpen(bool value);
  GitChanges? get _gitPanelChanges;
  set _gitPanelChanges(GitChanges? value);
  GitRepoInfo? get _gitPanelRepoInfo;
  set _gitPanelRepoInfo(GitRepoInfo? value);
  bool get _gitPanelLoading;
  ...
  int? get groupAssignProjectId;
  int? get renameProjectGroupId;
  bool get projectGroupsUnsupported;
  ...
  void closeGitPanel();
  Future<void> reloadGitChanges();
  Future<void> refreshGitPanel();
  Future<bool> gitStagePaths(List<String> paths);
  Future<bool> gitUnstagePaths(List<String> paths);
  ...
  Future<void> createProjectGroup(String name);
  ...
  TerminalStore get terminalStore;
