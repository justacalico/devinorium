...
abstract class AppStateBase extends ChangeNotifier {
  ...
  int? get _gitDialogProjectId;
  set _gitDialogProjectId(int? value);
  ...
  Future<void> _loadGitData(int projectId);
  Future<void> _loadGitBranchesAndWorktrees(int projectId);
  Future<void> gitCreateBranch(    int projectId,    String name, {    String? base,    bool switchBranch = false,  });
  Future<void> gitCheckout(    int projectId,    String refName, {    bool track = false,  });
  Future<void> gitPull(int projectId);
  Future<void> gitPullBranch(int projectId, String name);
  Future<void> gitPush(int projectId);
  Future<void> gitCreateWorktree(    int projectId,    String name,    String base, {    bool newBranch = false,  });
